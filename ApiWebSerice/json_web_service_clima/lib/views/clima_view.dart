...
import 'package:json_web_service_clima/controllers/clima.controller.dart';
...
class _ClimaViewState extends State<ClimaView> {
  ...
  Clima? _clima; // recebe as informações do clima e cidade
  String? _erro; //retonra o erro caso cidade não encontrada
